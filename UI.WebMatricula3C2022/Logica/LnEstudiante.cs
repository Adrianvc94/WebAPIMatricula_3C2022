...
namespace UI.WebMatricula3C2022.Logica
{
    public class LnEstudiante
    {
        ...
        public async Task<Models.Estudiante.Salida.VerTodosEstudiantes> VerTodosEstudiantes(
            Models.Estudiante.Entrada.VerTodosEstudiantes pDatos, string token)
        {
        ...
        public async Task<Models.Estudiante.Salida.VerDetalleEstudiante> VerDetalleEstudiante(
            Models.Estudiante.Entrada.VerDetalleEstudiante pDatos, string token)
        {
        ...
        public async Task<Models.Estudiante.Salida.AgregarEstudiante> AgregarEstudiante(
         Models.Estudiante.Entrada.AgregarEstudiante pDatos, string token)
        {
        ...
        public async Task<Models.Estudiante.Salida.EditarEstudiante> EditarEstudiante(
       Models.Estudiante.Entrada.EditarEstudiante pDatos, string token)
        {
        ...
        public async Task<Models.Estudiante.Salida.EliminarEstudiante> EliminarEstudiante(
      Models.Estudiante.Entrada.EliminarEstudiante pDatos, string token)
        {
